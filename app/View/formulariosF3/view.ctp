<span class="options">
	<a href="<?php echo $this->Html->url(array('action'=>'edit', $f3['f1_formularios']['id'])); ?>" class="btn btn-primary">Editar</a>
	<a href="<?php echo $this->Html->url(array('action'=>'export', $f3['f1_formularios']['id'])); ?>" class="btn btn-primary">Exportar</a>
	<a href="<?php echo $this->Html->url(array('action'=>'delete', $f3['f1_formularios']['id'])); ?>" class="btn btn-danger">Eliminar</a>
</span>
<hr />
<table class="table table-striped">
	...
	<?php 
		...
		$totales['porcinos']= 0;
		$totales['aves']= 0;
		foreach ($f3['FormulariosF3Detalle'] as $detalle) { ?>
			<tr>
